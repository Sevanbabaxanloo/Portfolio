...
const futurest = "/futurest.svg";
const basic = "/basic-logo.svg";
const emoji = "/me-emoji.svg";
...
const EduExp = () => {
  ...
  return (
    <div
      id="EduExp"
      className="global-margin w-full h-[900px] flex items-center justify-center max-md:py-[60px] max-md:px-[24px] max-md:h-content max-md:h-[1200px]"
    >
      <div className="global-padding flex flex-col items-center gap-[64px] max-md:w-full max-md:pt-0 max-md:gap-[32px]">
        <div className="max-md:w-full">
          <div className="text-center flex flex-col items-center gap-[32px]">
            <div className=" flex flex-col items-center max-md:w-[65vw]">
        ...
        <div className="w-[760px] flex flex-col gap-[50px] max-md:w-full">
          {obj.map((item, index) => (
            <div key={index} className="flex flex-col gap-[23px]">
              <div className="flex flex-row justify-between gap-[2.222vw] max-md:items-start max-md:justify-start max-md:flex-col max-md:items-start ">
