  ...
  return (
    ...
    >
      <div className="global-padding w-full flex flex-col items-center gap-16">
        ...
        <div className="grid w-full max-w-[920px] grid-cols-2 grid-rows-2 gap-[28px] justify-items-center max-lg:w-[700px] max-md:w-[91.146vw] max-sm:grid-cols-1 max-sm:grid-rows-4">
          {object.map((item, index) => (
            <div
              key={index}
              className="w-full h-[280px] rounded-[41px] bg-cover bg-center overflow-hidden max-lg:h-[208px] max-md:h-[240px] max-md:rounded-[22px] max-sm:h-[300px]"
